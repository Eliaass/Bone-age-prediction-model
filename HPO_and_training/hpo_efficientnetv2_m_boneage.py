# hpo_efficientnetv2_m_boneage.py
...
DEFAULT_HPO_DIR = f"{DEFAULT_PROJECT_DIR}/hpo_efficientnetv2_m_boneage"

DEFAULT_MODEL_NAME = "tf_efficientnetv2_m.in21k"
...
def get_search_space():
    return {
        "image_size": [512, 1024],
        "backbone_lr": "log-uniform [5e-6, 5e-5]",
...
def parse_args():
    ...
    parser.add_argument(
        "--study_name",
        type=str,
        default="hpo_efficientnetv2_m_boneage",
    )
