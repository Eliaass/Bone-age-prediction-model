...
#SBATCH --job-name=train_convnextv2_tiny
...
SCRIPT_PATH="$PROJECT_DIR/convnextv2_tiny_training.py"
...
echo "=== Starting ConvNeXtV2-Tiny final training ==="

python -u "$SCRIPT_PATH"

echo "=== ConvNeXtV2-Tiny final training finished ==="
echo "Date: $(date)"